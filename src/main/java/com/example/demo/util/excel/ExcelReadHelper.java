...
import com.example.demo.util.date.DateFormatUtils;
...
public class ExcelReadHelper {
	...
	public static <T> List<T> excelRead(File file,String[] properties,Class obj) throws Exception{
		Workbook book = null;
		try {
	 ...
	 * 
	 * @author zhangjingtao 
	 * @date 2018年1月18日 下午2:58:31
	 */
	@SuppressWarnings("rawtypes")
	public static <T> List<T> excelRead(String filePath,String[] properties,Class obj) throws Exception{
	...
	public static void main(String[] args) throws Exception {
		...
		properties[2] = "gender";
		properties[3] = "age";
		List<Student> list = excelRead("E:\\img\\avb.xls",properties,Student.class);
		for(Student s:list){
