...
public class MatrixToImageWriterEx {
	 ...
	 * 根据内容生成二维码数据
	 * 
	 * @param content  二维码文字内容 [为了信息安全性，建议先进行数据加密]
	 * @param width  二维码照片宽度
	 * @param height  二维码照片高度
	 * @return 
	 * 
	 * @author zhangjingtao 
	 * @date 2018年1月18日 下午5:58:28
	 */
	 ...
	 * @param logoPath logo路径
	 * @param logoConfig logo配置对象 可以定义logo的样式 
	 * @throws IOException
	 */
...
//                    outImage = outImage2;
//                }else {
//                    outg.drawString(productName, 200  - strWidth/2 , image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + (-150) ); //画文字 
//                }
////                outg.dispose(); 
//                outImage.flush();
////                image = outImage;
...
//            }
	...
	public static void main(String[] args) throws IOException {
		...
		BitMatrix bm = createQRCode(content,300,260);
		writeToFile(bm, "jpg", "E:\\img\\a.jpg", "E:\\img\\c.jpg");
	}
